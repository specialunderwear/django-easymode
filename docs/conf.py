# -*- coding: utf-8 -*-
#
# django-easymode documentation build configuration file, created by
...
htmlhelp_basename = 'django-easymodedoc'
...
latex_documents = [
  ('index', 'django-easymode.tex', u'django-easymode Documentation',
