...
SKIPPED_TESTS = ('test_permissions_for_change_view_are_evaluated_each_request',)
...
# gettext catalogs created from database data are
# stored here
LOCALE_DIR = '/tmp/'
...
# a gettext catalog will only kept for a site, if the
# MASTER_SITE property is set to True
MASTER_SITE = True
