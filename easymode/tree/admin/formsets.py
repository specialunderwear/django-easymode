...
from widgets.foreignkey import RenderLink
...
class VisiblePrimaryKeyFormset(BaseModelFormSet):
    ...
    def add_fields(self, form, index):
        ...
        form.fields[self._pk_field.name] = IntegerField( initial=pk_value, required=False, widget=RenderLink(attrs=attrs), label=_("Navigate to:"))
